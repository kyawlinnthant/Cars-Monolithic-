...
import com.sevenpeakssoftware.kyawlinnthant.app.Destinations
import com.sevenpeakssoftware.kyawlinnthant.domain.model.ThemeType
import kotlinx.coroutines.flow.collectLatest
import com.sevenpeakssoftware.kyawlinnthant.presentation.home.screens.FirstTimeErrorView
import com.sevenpeakssoftware.kyawlinnthant.presentation.home.screens.FirstTimeLoadingView
import com.sevenpeakssoftware.kyawlinnthant.presentation.home.screens.HasCarsView
            ...
            when (it) {
                is HomeUiEvent.NetworkError -> {
                    ...
                    when (result) {
                        ...
                        SnackbarResult.ActionPerformed -> vm.fetchCars()
                    }
                }
